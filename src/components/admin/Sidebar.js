            ...
            <ul className="list-unstyled components">
                ...
                <li>
                    ...
                    <ul className="collapse list-unstyled" id="trashSubmenu">
                        <li>
                            <Link to="/admin/trash/orders"><i className="fa fa-shopping-basket"></i> Đơn Hàng</Link>
                        </li>
        
                        <li>
                            <Link to="/admin/trash/products"><i className="fa fa-product-hunt"></i> Sản Phẩm</Link>
                        </li>

                        <li>
                            <Link to="/admin/trash/users"><i className="fa fa-users"></i> Người Dùng</Link>
                        </li>
                    </ul>
                </li>
            </ul>
